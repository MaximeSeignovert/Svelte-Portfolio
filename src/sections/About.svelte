...
<div class="flex justify-center align-center flex-col sm:flex-row w-[100%]">
  ...
  <div class="sm:w-[40%]">
    <p class="text-lg mb-4">Bienvenue sur mon portfolio ! Je suis développeur logiciel passionné actuellement basé à Grenoble.<br>
      ...
      <p class="text-lg mb-4">Je vous invite à parcourir mon portfolio pour découvrir mes réalisations et n'hésitez pas à me contacter si vous avez un projet en tête ou si vous souhaitez simplement échanger. Au plaisir de collaborer avec vous !
      </p>
