  ...
  <h2 class="text-2xl font-semibold pb-5 text-center" id="contact">Contact me</h2>
    ...
    <div class="max-w-[600px] my-0 mx-auto mb-[20px] p-[20px]">
      <form on:submit|preventDefault={submitForm} class="flex flex-col">
        ...
        <input class="mb-[15px] p-[10px] rounded text-black" type="email" id="email" bind:value={formData.email} required>
    
        <label class="mb-[5px]" for="message">Message :</label>
        <textarea class="mb-[15px] p-[10px] rounded text-black" id="message" bind:value={formData.message} required></textarea>
