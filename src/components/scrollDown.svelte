...
<script>
  ...
  {#if showIndicator}
    <div class="scroll-down-indicator z-30 fixed border-5 h-[150px] w-[100vw] bottom-0 bg-gradient-to-b from-transparent from-0% to-[--main-background-color] "  in:fade={{ duration: 300 }}
    out:fade={{ duration: 100 }}>
    <div class="flex justify-center items-end h-[100%] pb-4">
